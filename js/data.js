const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 나 너 많이 좋아해, 나랑 사귈래?', type: ['7', '10', '8', '9', '11' ] },
      { answer: 'c. 우리 내일은 연인으로 만날까요', type: ['0', '3', '6', '5' ] },
    ]
  },
  {
    q: '5. 오늘 연인과 첫 데이트 하는 날이다. 첫 날 허용할 수 있는 스킨십의 범위는?',
    a: [
      { answer: 'a. 손 잡기 정도??', type: ['1', '7', '10', '4', '9' ] },
      { answer: 'b. 요즘 시대가 어느 때인데, 가벼운 뽀뽀까지 가능이야', type: ['0', '3', '6', '11']},
      { answer: 'c. 뭐 어때?? 모든 스킨십 다 돼!', type: ['2', '5', '8'] },
    ]
  },

  {
    q: '6. 기념일이 다가온다. 당신은 어떻게 할 것인가? (ex 100일)',
    a: [
      { answer: 'a. 무슨 기념일이야, 그냥 평소처럼 해', type: ['4', '9', '11' ] },
      { answer: 'b. 근사한 곳에서 밥 먹을까? 아니면 꽃이라도?', type: ['0', '3', '6', '10' ] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 아니 갑자기 오면 어떡해 하 나 준비도 안 했는데 왜 오고그래 ㅠㅠ', type: ['4', '9', '11'] },
      { answer: 'b. 아 그래?? 나 할 것들 좀만 마무리하고 나갈게. 기다려줘!', type: ['0', '2', '6', '5' ] },
      { answer: 'c. 진짜?? 어디야?? 당장 나갈게!', type: ['1', '7', '3', '10', '8' ] },
    ]
  },
  {
    q: '11. 내가 추구하는 연애관은?',
  ...
  {
    q: '12. 연인과 데이트 도중 화를 참을 수 없을만큼 심하게 싸웠다.',
    a: [
      { answer: 'a. "따라오지마 오늘 집 갈 거니까." 라고 말하며 집으로 간다.', type: ['3', '6', '4', '9' ] },
      { answer: 'b. "내가 뭘 잘못했는데?" 소리지르며 끝까지 불같이 화낸다.', type: ['0', '2', '5', '10', '8'] },
...
const infoList = [
  {
    name: '연애 뭐 식은 죽 먹기죠, 연애 재능 만땅 <피카츄>',
    desc: '연애의 프로재능러인 당신! 피카츄에 해당하는 당신은 연애의 모든 것들을 알고 있어, 쉽게 연애에 성공하는 스타일이랍니다. 주로 포부가 크고 성격이 낙천적인 성향을 가지고 있고, 논리적이면서 두뇌회전이 매우 빠르다고 할 수 있어요. 말재주 또한 좋아 사교성이 좋고 유쾌하지만 화려한 것을 좋아해 허영심을 부리거나 사치를 부리기 때문에 이 점들을 주의해야 돼요. 뛰어난 능력에 자만하는 경우도 종종 있기 때문에 겸손이 필요하답니다! '
  },
  {
    name: '난 너만 봐, 정직한 연애 스타일의 <이브이>',
    desc: '연애 유형의 진국인 당신! 이브이에 해당하는 당신은 상대방만 바라보는 해바라기 연애 스타일이랍니다. 매사에 끈기가 있어 연애를 할 때 성실하고 진심을 다하는 성향을 가지고, 온화하며 따뜻한 마음을 가지고 있어요. 한 번 좋아하면 끝까지 좋아하는 의리파지만 자존심이 쌔 은근히 고집이 강하답니다. 또한 욱하는 성질이 있어 이런 부분들을 조심해야 하고, 질투심이 많아 사랑이 집착으로 바뀔 수 있어 주의해야 된답니다! '
  },
  {
    name: '사귀자, 사랑을 쟁취하는 <파이리>',
    desc: '한 번 좋아하는 사람이 있으면 내 사람으로 만드는 당신! 파이리에 해당하는 당신은 썸부터 사랑까지 한 번에 직진하는 스타일이랍니다. 연애할 때 주로 이끄는 성향을 가지고 있고, 시원시원한 성격과 유쾌한 성격을 가지고 있어요. 대쪽같은 성격에다 실수를 용납하는 대인배지만 유혹에 약하고 허영때문에 들뜨는 성격이라 다른 이성의 접근에 주의해야 돼요. 또한 내가 한 말로 인해 상대방이 상처를 받을 수 있기 때문에, 항상 말 조심이 필요하답니다!'
  },
  {
    name: '이건 어때? 난 어때? 독특한 매력을 가진 <푸린>',
  ...
  {
    name: '결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 <캐이시>',
    desc: '상대방과의 미래를 꿈꾸는 당신! 현실적인 연애보다는, 미래에 대한 이상적인 연애관을 가지고 있어요. 매일매일 사랑하는 사람과 보낼 미래를 생각하기 때문에, 좋은 배우자가 될 수 있는 자질이 있답니다. 또한 일적으로나 사랑으로나 야망이 커, 크게 성공할 확률이 높고 리더십이 매우 뛰어나답니다. 다만 높은 이상에 비해서 현실이 자신의 마음에 들지 않으면 허세를 부리거나 사람들을 무시하는 경우가 많으니 이점들을 주의하면 좋을 것 같아요!'
  },
  {
    name: '기념일에 무슨 이벤트 할까, 이벤트 플래너 <이상해씨>',
  ...
  {
    name: '어 오늘 머리 바꿨네 잘 어울린다, 센스가 뛰어난 <꼬부기>',
  ...
  {
    name: '산은 산이요 연애는 연애로다, 느긋하고 온순한 <잠만보>',
